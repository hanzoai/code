...
import { CODE_OPEN_SETTINGS_ACTION_ID } from '../../code/browser/codeSettingsPane.js';
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
	...
	command: {
		...
		title: nls.localize({ key: 'openCode', comment: ['&& denotes a mnemonic'] }, "&&Open Code Settings"),
	},
	order: 1
});
