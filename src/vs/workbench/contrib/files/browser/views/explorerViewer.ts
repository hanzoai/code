...
export class FilesRenderer implements ICompressibleTreeRenderer<ExplorerItem, FuzzyScore, IFileTemplateData>, IListAccessibilityProvider<ExplorerItem>, IDisposable {
	...
	// const codeButtonsContainer = DOM.append(container, DOM.$('div'));
	// codeButtonsContainer.style.position = 'absolute'
	// codeButtonsContainer.style.top = '0'
	// codeButtonsContainer.style.right = '0'
	// // const codeButtons = DOM.append(codeButtonsContainer, DOM.$('span'));
	// // codeButtons.textContent = 'voidbuttons'
	// // codeButtons.addEventListener('click', () => {
	// // 	console.log('ON CLICK', templateData.currentContext?.children)
	// // })
	// const codeLabels = this.labels.create(codeButtonsContainer, { supportHighlights: false, supportIcons: false, });
	// codeLabels.element.textContent = 'hi333'
	...
	// Code cares about this function, this is where elements in the tree are rendered
