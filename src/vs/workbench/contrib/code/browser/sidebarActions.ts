...
registerAction2(class extends Action2 {
	constructor() {
		super({ id: CODE_OPEN_SIDEBAR_ACTION_ID, title: localize2('codeOpenSidebar', 'Code: Open Sidebar'), f1: true });
	}
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			f1: true,
			title: localize2('codeCmdL', 'Code: Add Selection to Chat'),
			keybinding: {
	...
	async run(accessor: ServicesAccessor): Promise<void> {
		...
		// open panel
		const wasAlreadyOpen = viewsService.isViewContainerVisible(CODE_VIEW_CONTAINER_ID)
		if (!wasAlreadyOpen) {
...
const CODE_CMD_SHIFT_L_ACTION_ID = 'void.cmdShiftL'
registerAction2(class extends Action2 {
	constructor() {
		super({
			id: CODE_CMD_SHIFT_L_ACTION_ID,
			title: 'New Chat',
			keybinding: {
...
registerAction2(class extends Action2 {
	...
	async run(accessor: ServicesAccessor): Promise<void> {
		...
		commandService.executeCommand(CODE_CMD_SHIFT_L_ACTION_ID)
