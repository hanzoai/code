...
import { Diff, DiffArea, CodeFileSnapshot } from '../common/editCodeServiceTypes.js';
...
export interface IEditCodeService {
	...
	// testDiffs(): void;
	getCodeFileSnapshot(uri: URI): CodeFileSnapshot;
	restoreCodeFileSnapshot(uri: URI, snapshot: CodeFileSnapshot): void;
}
