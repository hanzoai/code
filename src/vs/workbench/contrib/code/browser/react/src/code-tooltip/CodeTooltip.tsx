 ...
 * To use:
 * 1. Mount a Tooltip with some id eg id='code-tooltip'
 * 2. Add data-tooltip-id="code-tooltip" and data-tooltip-content="Your tooltip text" to any element
 */
export const CodeTooltip = () => {
	...
	return (
		...
		<>
			...
			/>
			<Tooltip
				id="code-tooltip-orange"
				border='1px solid rgba(200,200,200,.3)'
				opacity={1}
				delayShow={50}
			/>
			<Tooltip
				id="code-tooltip-green"
				border='1px solid rgba(200,200,200,.3)'
				opacity={1}
				delayShow={50}
			/>
			<Tooltip
				id="code-tooltip-ollama-settings"
				border='1px solid rgba(100,100,100,.2)'
				opacity={1}
