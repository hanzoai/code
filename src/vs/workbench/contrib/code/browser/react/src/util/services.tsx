...
let settingsState: CodeSettingsState
const settingsStateListeners: Set<(s: CodeSettingsState) => void> = new Set()
...
export const useAccessor = () => {
	if (!reactAccessor_) {
		throw new Error(`⚠️ Code useAccessor was called before _registerServices!`)
	}
