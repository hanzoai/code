...
import { CodeCodeEditor, CodeCodeEditorProps } from '../util/inputs.js';


export const BlockCode = ({ buttonsOnHover, ...codeEditorProps }: { buttonsOnHover?: React.ReactNode } & CodeCodeEditorProps) => {
	...
	return (
		<>
			<div className="relative group w-full overflow-hidden my-4">
				...
				<CodeCodeEditor {...codeEditorProps} />
			</div>
		</>
	)
}
