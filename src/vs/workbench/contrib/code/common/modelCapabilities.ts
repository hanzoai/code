...
import { FeatureName, ModelSelectionOptions, OverridesOfModel, ProviderName } from './codeSettingsTypes.js';
...
export type CodeStaticModelInfo = { // not stateful
	// Code uses the information below to know how to handle each model.
...
type CodeStaticProviderInfo = { // doesn't change (not stateful)
	...
	modelOptions: { [key: string]: CodeStaticModelInfo };
	modelOptionsFallback: (modelName: string, fallbackKnownValues?: Partial<CodeStaticModelInfo>) => (CodeStaticModelInfo & { modelName: string, recognizedModelName: string }) | null;
}
...
const defaultModelOptions = {
	...
	supportsFIM: false,
	reasoningCapabilities: false,
} as const satisfies CodeStaticModelInfo
...
} as const satisfies { [s: string]: Partial<CodeStaticModelInfo> }




// keep modelName, but use the fallback's defaults
const extensiveModelOptionsFallback: CodeStaticProviderInfo['modelOptionsFallback'] = (modelName, fallbackKnownValues) => {

	const lower = modelName.toLowerCase()

	const toFallback = <T extends { [s: string]: Omit<CodeStaticModelInfo, 'cost' | 'downloadable'> },>(obj: T, recognizedModelName: string & keyof T)
		: CodeStaticModelInfo & { modelName: string, recognizedModelName: string } => {
...
} as const satisfies { [s: string]: CodeStaticModelInfo }

const anthropicSettings: CodeStaticProviderInfo = {
...
const openAISettings: CodeStaticProviderInfo = {
...
const xAISettings: CodeStaticProviderInfo = {
...
const geminiSettings: CodeStaticProviderInfo = {
...
const deepseekSettings: CodeStaticProviderInfo = {
...
const mistralSettings: CodeStaticProviderInfo = {
...
const groqSettings: CodeStaticProviderInfo = {
...
} as const satisfies Record<string, CodeStaticModelInfo>
const googleVertexSettings: CodeStaticProviderInfo = {
...
const microsoftAzureSettings: CodeStaticProviderInfo = {
...
const awsBedrockSettings: CodeStaticProviderInfo = {
...
const vLLMSettings: CodeStaticProviderInfo = {
...
const lmStudioSettings: CodeStaticProviderInfo = {
...
const ollamaSettings: CodeStaticProviderInfo = {
	modelOptionsFallback: (modelName) => extensiveModelOptionsFallback(modelName, { downloadable: { sizeGb: 'not-known' } }),
...
const openaiCompatible: CodeStaticProviderInfo = {
...
const liteLLMSettings: CodeStaticProviderInfo = { // https://docs.litellm.ai/docs/reasoning_content
	modelOptionsFallback: (modelName) => extensiveModelOptionsFallback(modelName, { downloadable: { sizeGb: 'not-known' } }),
	modelOptions: {},
	providerReasoningIOSettings: {
		input: { includeInPayload: openAICompatIncludeInPayloadReasoning },
...
const openRouterSettings: CodeStaticProviderInfo = {
...
const modelSettingsOfProvider: { [providerName in ProviderName]: CodeStaticProviderInfo } = {
