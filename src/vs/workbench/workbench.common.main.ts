...
//#region --- Code
import './contrib/code/browser/code.contribution.js'; // Code added this
//#endregion
...
// Chat
// Code - this is still registered to avoid console errors, we just commented it out in chatParticipant.contribution.ts
