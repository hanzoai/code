...
export class LLMMessageService extends Disposable implements ILLMMessageService {
	...
	constructor(
		...
		// const service = ProxyChannel.toService<LLMMessageChannel>(mainProcessService.getChannel('code-channel-sendLLMMessage')); // lets you call it like a service
		// see llmMessageChannel.ts
		this.channel = this.mainProcessService.getChannel('code-channel-llmMessageService')
	...
	sendLLMMessage(params: ServiceSendLLMMessageParams) {
		...
		const modelSelection = this.codeSettingsService.state.modelSelectionOfFeature[featureName]
		...
		const { aiInstructions } = this.codeSettingsService.state.globalSettings
		const { settingsOfProvider } = this.codeSettingsService.state
