...
export const modelInfoOfDefaultNames = (modelNames: string[], options?: { isAutodetected: true, existingModels: CodeModelInfo[] }): CodeModelInfo[] => {
	...
	if (!existingModels) { // default settings
		...
		const existingModelsMap: Record<string, CodeModelInfo> = {}
